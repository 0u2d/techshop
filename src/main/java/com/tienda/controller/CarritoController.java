...
public class CarritoController {
    ...
    public ModelAndView agregar(
        ...
        try {
            ...
            BigDecimal totalDolares = convierteADolar(totalColones);
    ...
    private BigDecimal convierteADolar(BigDecimal totalColones) {
        String tCambio = constanteService.demeValorDeAtributo("dolar");
        double precioDolar = Double.parseDouble(tCambio);
        return totalColones.divide(BigDecimal.valueOf(precioDolar), RoundingMode.CEILING);    
